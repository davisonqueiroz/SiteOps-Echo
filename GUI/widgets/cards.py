...
class Card(QFrame):
    ...
    def create_front_card(self,title,bg_color_card,btn_opt_color,color_opt_name,color_hover_opt,btn_gnrt_color,color_gnrt_name,color_hover_gnrt):
        ...
        btn_info = self.create_btn("i","#F5F5F5","#0C0C0D","10px","#CCCCCC",20,20)
    ...
    def create_back_card(self,bg_color_card,description):
        ...
        btn_close = self.create_btn("x","#F5F5F5","#0C0C0D","10px","#CCCCCC",20,20)
    ...
    def switch_text_btn(self,key_btn,side = "front"):
        ...
        if self.paths[key_btn]:
            ...
            button.setText("Selecione o arquivo")
